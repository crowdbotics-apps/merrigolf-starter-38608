...
## Project Structure
    ...
    ├── merrigolf_starter_38608  # Django project configurations
...
1. Clone this repo and `cd merrigolf_starter_38608`
...
2. Clone this repo and `cd merrigolf_starter_38608`
